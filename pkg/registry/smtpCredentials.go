...
func (s SmtpCredentials) GetTransformConfig() cryptostruct.TransformConfig {
	return cryptostruct.TransformConfig{
		Decrypted: SmtpCredentials{},
		Encrypted: SecureSmtpCredentials{},
	}
}

type SecureSmtpCredentials struct {
	Username     string                    `json:"username,omitempty" yaml:"username,omitempty" mapstructure:"username,omitempty" secure:"true"`
	Password     string                    `json:"password,omitempty" yaml:"password,omitempty" mapstructure:"password,omitempty" secure:"true"`
	CryptoParams cryptostruct.CryptoParams `json:"cryptoParams" yaml:"cryptoParams" mapstructure:"cryptoParams"`
}

func (s SecureSmtpCredentials) GetCryptoParams() cryptostruct.CryptoParams {
	return s.CryptoParams
}

func (s SecureSmtpCredentials) GetTransformConfig() cryptostruct.TransformConfig {
	return cryptostruct.TransformConfig{
		Decrypted: SmtpCredentials{},
		Encrypted: SecureSmtpCredentials{},
	}
